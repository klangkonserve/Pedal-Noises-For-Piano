...
2. Samples:
You need the WAV files, they are zipped at [Nextcloud](https://rodehutskors.com/owncloud/index.php/s/WYesCXwELB3nBPP). Copy the folder `Samples` containing the WAV files to the same level as the SFZ files.
...
2. Samples:
Du benötigst die WAV-Dateien, die als ZIP-Archiv auf der [Nextcloud](https://rodehutskors.com/owncloud/index.php/s/WYesCXwELB3nBPP) zu finden sind. Kopiere den Ordner `Samples`, der die WAV Dateien enthält, auf das gleiche Level wie die SFZ Dateien.
